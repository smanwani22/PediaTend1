...
public class VitalEntry12Up {

    public VitalEntry12Up() {}

    Text logoTitle = new Text("PediaTend");
    Text pageTitle = new Text("Vitals Entry");
    HBox hbTitle = new HBox(100, logoTitle, pageTitle);

    Label patName = new Label("Patient: John Doe");
    Label patAge = new Label("Age: 19years 3months");
    ...
    Label patBP = new Label("Blood Pressure: ");
    TextField tfBP = new TextField();
    HBox hbBP = new HBox(10, patBP,tfBP);
    ...
    VBox center = new VBox(10,vbPat,hbWeight,hbHeight,hbTemp,hbBP,hbProceed);
    ...
    public void set() {
        ...
        tfBP.setPrefWidth(216);
        tfBP.setPromptText("only enter if patient > 12 years old");
        ...
        patBP.setFont(Font.font("Verdana", FontWeight.SEMI_BOLD, 15));
    ...
    public void setInfo(ArrayList<Patient> patients, TextField tfWeight, TextField tfHeight, TextField tfTemp, TextField tfBP){
//        Patient patient = new Patient();
        double weight = Double.parseDouble(tfWeight.getText());
        int height = Integer.parseInt(tfHeight.getText());
        double temp = Double.parseDouble(tfTemp.getText());
        int bloodPressure = Integer.parseInt(tfBP.getText());
